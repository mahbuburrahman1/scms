...
$topic = $resultNotification['topic'];
$timeNeeded = $resultNotification['timeNeeded'];
...
$subject = "Schedule Request Accepted! -SCMS";


            
$message = "<h1>SCMS</h1> <br> Your request to <b>Mr. ".$teacherName."</b>, have been <b style='color:green'>accepted!</b> schedule time is <b>".$weekDay."</b> at <b>".$startTime."</b> for <b>".$timeNeeded."</b> min about <b>".$topic."</b>";
